    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active fw-semibold" aria-current="page" href="{{ route('home') }}"
            ...
            @auth
                <div class="d-flex align-items-center me-3">
                    ...
                    <!-- Cart Button -->
                    <a href="{{ route('cart.view') }}" class="btn btn-outline-dark btn-sm position-relative me-2">
                    ...
                    <!-- Orders Button -->
                    <a href="{{ route('orders.index') }}" class="btn btn-outline-dark btn-sm position-relative">
                        <i class="bi bi-bag-check-fill me-1"></i>
                        Orders
                        <span class="position-absolute top-0 start-100 translate-middle badge bg-danger rounded-pill">
                            {{ auth()->user()->orders()->where('status', '!=', 'cancelled')->count()
 }}
